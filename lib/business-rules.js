...
export function isFallbackVoucherCampaignId(value = "") {
  return String(value || "").startsWith("fallback-");
}

export function toPersistedVoucherCampaignId(value = "") {
  const normalized = String(value || "").trim();
  return normalized && !isFallbackVoucherCampaignId(normalized) ? normalized : "";
}
