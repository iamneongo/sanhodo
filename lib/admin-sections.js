export const ADMIN_SECTIONS = [
  ...
  { key: "staff", label: "Nhân sự", description: "Quản lý tài khoản nội bộ, vai trò và chi nhánh chính.", permission: "staff.view" },
  ...
  { key: "media", label: "Media", description: "Quản lý ảnh, video, logo, banner và PDF theo chi nhánh.", permission: "media.view" },
