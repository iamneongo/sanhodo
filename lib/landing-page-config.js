...
export function normalizeLandingPageConfig(config = {}) {
  return {
    ...
    themeKey: cleanConfigText(config.themeKey),
    cityLabel: cleanConfigText(config.cityLabel),
    experienceTagline: cleanConfigText(config.experienceTagline),
    messengerUrl: cleanConfigText(config.messengerUrl),
    latitude: cleanConfigText(config.latitude),
    longitude: cleanConfigText(config.longitude),
